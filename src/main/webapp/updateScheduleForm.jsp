...
<div class="container">
	...
	<div class="well-searchbox">
    	<form action="updateScheduleProc.jsp" class="form-horizontal" role="form">
            <div class="form-group">
	            <h4><label class="col-md-3 control-label">월</label></h4>
                <div class="col-md-6">
    		        <select class="form-control" name="updateMonth">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6" style="text-size:15px;">
     	           <select class="form-control" name="updateDay">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
             	   <input type="text" class="form-control" name="updateTitle" required value="<%= title %>"></input>
                </div>
            </div><br>
            <div class="form-group">
            	<h4><label class="col-md-3 control-label">내용</label></h4>
                <div class="col-md-6">
                	<textarea class="form-control" name="updateContent" cols="102" rows="6" style="resize:none"><%= content %></textarea>
                </div>
            </div><br>
            <div class="col-sm-offset-5 col-sm-5">
            	<button type="submit" class="btn btn-success" name="input" style="width: 80px;">수 정</button>
            </div>
        </form>
    </div>
</div>
